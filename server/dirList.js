function dirList(a, b) {
    pathname = -1 === a.indexOf("../") ? a : a.slice(2), dirpath = a.lastIndexOf("/") === a.length - 1 ? pathname : pathname + "/", htmlStr = fs.readFileSync("../html/dirList.ejs", {encoding: "utf-8"}), fs.readdir(a, function (c, d) {
